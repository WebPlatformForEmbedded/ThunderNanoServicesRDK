...
<a id="head_PerformanceMetrics_Plugin"></a>
...
This document describes purpose and functionality of the PerformanceMetrics plugin. It includes detailed specification about its configuration and methods provided.
...
The following methods are provided by the PerformanceMetrics plugin:
...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "PerformanceMetrics.1.versions"
}
```
...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "PerformanceMetrics.1.exists",
  "params": {
    "method": "versions"
  }
}

...
namespace TZ {
    ...
    void TimeZoneSupport::HandleTimeZoneFileUpdate(GFileMonitor *monitor VARIABLE_IS_NOT_USED, GFile *file, GFile *other VARIABLE_IS_NOT_USED, GFileMonitorEvent evtype, gpointer user_data) {

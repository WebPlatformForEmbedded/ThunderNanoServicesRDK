...
| locator | string | Library name: *libThunderWebKitBrowser.so* |
...
- [WebKitBrowser.json](https://github.com/rdkcentral/ThunderInterfaces/tree/master/interfaces/WebKitBrowser.json)
